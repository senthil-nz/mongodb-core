...
function connectNewServers(self, servers, callback) {
  ...
  function execute(_server, i) {
    setTimeout(function() {
      ...
      var hostName = _server.split(':')[0];
      var portNumber = parseInt(_server.split(':')[1], 10);
      //handle IPv6 address
      if (_server.startsWith('[')) {
        hostName = _server.split(']:')[0] + "]";
        portNumber = parseInt(_server.split(']:')[1], 10);
